...
export type ListTxsQuery = { transactions: Array<{ id: string, createdAt: string, dao: { id: string } }> };
...
export type FindTxQuery = { transaction?: { id: string, createdAt: string, dao: { id: string } } | undefined };
