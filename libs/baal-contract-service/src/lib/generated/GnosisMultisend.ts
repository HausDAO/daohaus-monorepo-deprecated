...
export interface GnosisMultisendInterface extends utils.Interface {
  functions: {
...
export interface GnosisMultisend extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GnosisMultisendInterface;
