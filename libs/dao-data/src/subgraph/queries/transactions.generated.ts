...
export type FindLatestTxQuery = {
  transactions: Array<{ id: string; createdAt: string }>;
};

export const FindLatestTxDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'findLatestTx' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'EventTransaction_filter' },
            },
          },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'EventTransaction_orderBy' },
            },
          },
        ...
        selections: [
          {
            ...
            name: { kind: 'Name', value: 'eventTransactions' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'where' },
...
} as unknown as DocumentNode<FindLatestTxQuery, FindLatestTxQueryVariables>;
