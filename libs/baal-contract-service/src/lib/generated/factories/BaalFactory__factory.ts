...
import type { BaalFactory, BaalFactoryInterface } from "../BaalFactory";
...
export class BaalFactory__factory {
  static readonly abi = _abi;
  static createInterface(): BaalFactoryInterface {
    return new utils.Interface(_abi) as BaalFactoryInterface;
  }
  static connect(
    address: string,
