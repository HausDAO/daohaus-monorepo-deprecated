import { ViteHelperExecutorSchema } from './schema';
...
import { replaceFiles } from '../plugins/replace-files';
import { checkDependencies } from '../utils/check-depedencies';
...
export default async function runExecutor(
  options: ViteHelperExecutorSchema,
  ...
  const viteBaseConfig = await ensureUserConfig(
    baseConfig,
    context.configurationName as string
  );
